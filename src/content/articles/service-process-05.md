---
title: 步驟四：擬定策略
description: "財務規劃步驟四根據診斷結果擬定策略，分短中長期行動方向，逐項說明各方案優缺點與替代選項，讓你在充分了解後自行做出決策。"
faq:
  - q: "財務策略規劃會直接告訴我該怎麼做嗎？"
    a: "不會只給你一個答案。每一項策略建議都會說明問題、具體行動、原因、優缺點與替代方案，讓你了解來龍去脈後自己做判斷，顧問的角色是提供建議，決策者是你。"
  - q: "策略規劃的時間範圍是怎麼區分的？"
    a: "分成三個時間維度：短期是現在就可以執行的行動，例如調整保險或處理高利率負債；中期是未來 3–5 年的規劃，例如投資配置或購房準備；長期則是 5 年以上的目標，如退休金準備與傳承規劃。"
  - q: "策略建議出來後，所有事項都要立刻執行嗎？"
    a: "不需要。策略有優先順序之分，有些事情急、有些可以等。策略建議書會清楚說明每項行動的優先順序與預期效果，讓你知道現在該做什麼、未來要往哪個方向走。"
  - q: "日後情況改變，策略可以調整嗎？"
