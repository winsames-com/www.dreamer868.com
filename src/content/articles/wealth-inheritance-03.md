---
title: 傳承工具介紹 - 信託
description: "信託讓你在身後仍能控制資產如何被使用：可設定分期給付、用途限制、跨代傳承。介紹常見信託類型、與遺囑的差異，以及設立前的成本與稅務考量。"
faq:
  - q: "信託和遺囑有什麼不同？有遺囑還需要信託嗎？"
    a: "遺囑說的是「給誰」，信託說的是「怎麼給」。遺囑是身故後一次性移轉資產；信託可以生前生效，並設定長期使用條件，例如每月分批給付或限定用途。兩者可以搭配使用，不互相取代。"
  - q: "設立信託要花多少錢？費用高嗎？"
    a: "信託有設立費用，以及每年依資產比例計算的管理費，需要達到一定金額才划算。設立前建議先和專業人士討論，確認信託是否符合你的實際需求。"
  - q: "擔心孩子繼承後亂花錢，信託能解決嗎？"
    a: "可以。信託可以設定分期給付或限制資金用途，例如只能用於生活費、教育費，避免受益人一次拿到大筆錢後揮霍。這是信託在傳承規劃中最常見的應用之一。"
  - q: "他益信託會有贈與稅問題嗎？"
