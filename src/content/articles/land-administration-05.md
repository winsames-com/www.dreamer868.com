---
title: 非都市土地開發的機會
description: "非都市土地的開發潛力取決於使用分區與類別，農地限制嚴格，違規建築有法律風險。評估開發可行性需了解分區現況、變更程序與回饋金成本，不可僅憑仲介說詞，務必尋求地政士等專業評估。"
faq:
  - q: "我的非都市土地到底能做什麼用途，要怎麼查？"
    a: "非都市土地依「使用分區」和「使用地類別」兩個維度分類，能做什麼取決於兩者的組合。拿到地號後先查清楚這兩項，再對照非都市土地使用管制規則，才能確認實際可行的用途。"
  - q: "農地可以改建成住宅嗎？"
    a: "農地農用是原則，不能隨便蓋房子。若要改建，需申請變更使用地類別——一般農業區有機會，特定農業區則非常困難，過程須審查、環評、繳回饋金等。違規建築有法律風險，不要輕信能蓋別墅的說法。"
  - q: "買非都市土地投資，有哪些風險要注意？"
    a: "主要三種風險：法規可能變動，目前無法開發的地將來也未必能用；申請開發許可程序冗長，政策也可能中途改變；開發期間資金可能長期被套住。購買前務必委託地政士、都市計畫技師等專業人員做完整可行性評估，不要只聽仲介說法。"
date: 2026-03-19
author: Writer
status: published
version: 1
