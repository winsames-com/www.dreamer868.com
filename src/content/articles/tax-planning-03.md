---
title: 傳承相關稅務（遺贈稅）
description: "遺產稅與贈與稅是財富傳承的核心課題，說明兩稅的計算架構與稅率、常被忽略的課稅資產，以及分年贈與、保險規劃、信託等工具，並強調提前規劃的必要性。"
faq:
  - q: "遺產稅的免稅額是多少，配偶和子女有沒有額外扣除？"
    a: "現行免稅額為1,333萬，另有配偶扣除額553萬、每位直系血親卑親屬扣除額56萬、父母扣除額每人138萬等各項扣除。扣除所有適用項目後，才計算應納稅額。"
  - q: "每年贈與多少錢以內不用繳贈與稅？"
    a: "每人每年贈與免稅額為244萬。夫妻各自擁有這個額度，合計每年可移轉488萬，是分年傳承最基本的工具。"
  - q: "臨終前才開始贈與，還來得及節稅嗎？"
    a: "效果有限。死亡前兩年內的贈與會被併入遺產重新計算，等於節稅白做。要真正發揮分年贈與的效果，必須提早規劃。"
  - q: "遺產稅要在什麼期限內繳清？"
