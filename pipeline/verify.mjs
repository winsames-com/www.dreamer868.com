...
- anonymization_ok：布林，改編稿是否確實去識別化。**判 false 的情形包含**：出現任何「姓＋名」的全名（姓氏後面直接接一到兩個字的名字，即三字或兩字的完整姓名寫法，即使是虛構的也一律不合格；人物只准用「陳先生／王小姐」這類姓＋通用稱謂，或「駕駛人／長子／配偶」這類角色）、真實姓名、公司全名、身分證、統編、電話、完整門牌等可辨識資訊。
